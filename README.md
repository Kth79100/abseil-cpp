...
1. Locate the folder where you saved the files.
2. Double-click the file to start the setup process.
3. Follow the prompts on the screen.
4. Select the location on your hard drive where you want the library to live.
...
2. Include the library path in your project settings.
3. Add the header files to your project folder.
4. Compile your program to link the library.
